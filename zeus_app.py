...
# === INTERFACE: ABA "Treino" ===
aba = st.selectbox("Escolha uma seção", ["Treino", "Dieta da Semana", "Suplementos e Receitas", "Gerar PDF"])
if aba == "Treino":
    user = st.session_state["usuario"]  # <- Adicione isso aqui
...
# === INTERFACE: ABA "Suplementos e Receitas" ===
...
# === INTERFACE: ABA "Gerar PDF" ===
    ...
    if st.button("Gerar PDF"):
        conteudo = ["Plano de Treino:"] + treino + ["", "Plano de Dieta:"] + dieta + \
                   ["", "Suplementos:"] + suplementos + ["", "Receitas:"] + receitas
